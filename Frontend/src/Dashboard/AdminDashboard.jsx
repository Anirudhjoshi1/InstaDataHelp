  ...
  const trainers = [
    {
      id: 1,
      name: "Manoj Tibrewal",
      trainees: ["Anurishi Jain", "Rahul Sharma"],
    },
      ...
      <div className="dashboard-content">
        ...
        <div className="summary-cards">
          ...
          <div className="summary-card">
            Total Trainees:{" "}
            {trainers.reduce((sum, t) => sum + t.trainees.length, 0)}
          </div>
        ...
        <div className="activity-log">
          ...
          <ul className="activity-list">
            <li className="activity-item">
              ✔️ Anurishi Jain was assigned to Manoj Tibrewal
            </li>
            <li className="activity-item">
              ✔️ Neha Gupta was reassigned to Sanya Kapoor
            </li>
            <li className="activity-item">
              ❌ Rahul Sharma was removed from training
            </li>
          </ul>
        </div>
      </div>
